    ...
    <div class="container">
        ...
        <div class="erdar">
            <div class="mb-4">
                ...
                <input type="email" name="endereco-email" id="endereco-email">
            </div>
        ...
        <div class="row campos">
            ...
            <div class="col-4 mb-4">
                ...
                <select class="input-group" aria-label="Default select example" name="codigo" id="codigo">
            ...
            <div class="col-6 mb-4">
                ...
                <input class="input-group" type="date" name="data" id="data">
            </div>
            <div class="col-6 mb-4">
        ...
        <div class="mb-4 subtitulos">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sms" id="flexRadioDefault1">
                <label class="form-check-label" for="flexRadioDefault1">
                    Sim
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sms" id="flexRadioDefault2" checked>
        ...
        <div>
            <div class="termos-registo mb-4">
                <p>A) REGISTO NO PORTAL DE LEILÕES LEILOSOC <br>
                    ...
                    5. Os bens são vendidos nas condições, estado físico e jurídico em que se encontram, pelo que a LEILOSOC
                    ...
                    pré-definido
                    ou por marcação. Quando o período de visitas é pré-definido, o horário e morada física em que os bens
                    podem
                    ser
                    ...
                    7. O leilão decorrerá no período publicitado na área do leilão, sendo constituído por uma data e hora de
                    ...
                    do
                    email, dado que o serviço de entrega e receção do correio eletrónico não é de sua responsabilidade. <br>
                    14.Todas as restantes licitações (que não venceram o leilão) são automáticamente arquivadas. CONDIÇÕES
                    GERAIS DE VENDA ONLINE www.leilosoc.pt · geral@leilosoc.pt <br>
                    E) COMISSÕES PELOS SERVIÇOS PRESTADOS <br>
                    15. Ao valor da venda acresce uma comissão pelos serviços prestados pela LEILOSOC Market Partners® e IVA
                    ...
                    16. Em caso de adjudicação de um ou mais bens, o licitante será contactado após o términus do leilão, de
                    forma a proceder ao
                    pagamento da
                    ...
                    facto
                    de os participantes não possuírem capacidade jurídica plena para venderem ou comprarem os produtos. <br>
                    25.
                    ...
                    atividade
                    fraudulenta promovida ou exercida pelo participante do leilão e relacionada com o leilão online. <br>
                    28.
                    Na
                    ...
                    participante do leilão, inserindo-os numa base de dados apropriada e pela qual será responsável. <br>
                    39.
                    Os
